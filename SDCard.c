...
{
 uint8_t idata SPI_send, return_val, SPI_return, error_flag;
...
uint8_t read_block_ISR(uint16_t num_bytes, uint8_t * array_out)
{
   uint8_t idata error_flag,return_val,SPI_return;
